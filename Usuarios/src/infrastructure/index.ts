...
import auditRoutes from '../../../Auditorias/src/adapters/routes/auditRoutes';
...
const rabport = process.env.RABPORT || 3002;
...
import { connectRabbitMQ } from '../services/rabbit/rabbitmq';

const startServer = async () => {
    try {
        await connectRabbitMQ();
        app.listen(rabport, () => console.log(`Servidor corriendo en el puerto ${rabport}`));
    } catch (error) {

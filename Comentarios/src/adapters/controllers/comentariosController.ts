...
import { crearComentarioService } from '../uses_cases/crearComentario';
import { obtenerComentariosPorQueja } from '../uses_cases/GetCoemnts';
import { eliminarComentario } from '../uses_cases/deleteComents';

export class ComentarioController {
    constructor() { }

    crearComentarios = (req: Request, res: Response) => crearComentarioService(req, res);
    obtenerComentarios = (req: Request, res: Response) => obtenerComentariosPorQueja(req, res);
    eliminarComentarios = (req: Request, res: Response) => eliminarComentario(req, res);
}
